    ...
    <div className="min-h-screen font-sans antialiased bg-slate-50 text-slate-900">
        ...
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-slate-500">Research workflow for humans (and impatient devs)</div>
            </div>
          </div>
          <nav className="hidden md:flex items-center gap-4">
            <a href="#what" className="text-sm hover:text-slate-800">What</a>
            <a href="#how" className="text-sm hover:text-slate-800">How it works</a>
            <a href="#devpost" className="text-sm hover:text-slate-800">Devpost</a>
            <a href="#team" className="text-sm hover:text-slate-800">Team</a>
            <a href="#demo" className="inline-flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-md text-sm hover:bg-blue-700"><FiExternalLink /> Live Demo</a>
          </nav>
          <div className="md:hidden text-sm text-slate-600">Menu</div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-6 py-12">
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-lg text-slate-600">Collect open browser tabs, auto-summarize content using client-side AI (Gemini Nano / Chrome Built-in AI), organize findings into sessions, and export a polished submission for the Google Chrome Built-in AI Challenge 2025.</p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <a href="#demo" className="inline-flex items-center gap-2 border border-slate-200 px-4 py-3 rounded-full hover:bg-slate-100">View Demo <FiExternalLink /></a>
            </div>
          ...
          <div className="relative">
            <div className="w-full h-72 bg-gradient-to-br from-slate-100 to-white rounded-2xl shadow-lg p-6">
              <div className="flex items-start justify-between">
                <div>
                  <div className="text-xs uppercase text-slate-500">Tabwise — session</div>
              ...
              <div className="mt-6 grid grid-cols-1 gap-3">
                <div className="bg-white p-3 rounded-md border flex items-start gap-3">
                  <div className="w-8 h-8 rounded-sm bg-slate-200" />
                  <div className="flex-1">
                    <div className="font-medium">How the Summarizer API works</div>
                    <div className="text-xs text-slate-500">Auto-extract the TL;DR and key points from long docs.</div>
                  </div>
                </div>
                <div className="bg-white p-3 rounded-md border flex items-start gap-3">
                  <div className="w-8 h-8 rounded-sm bg-slate-200" />
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-slate-500">One-click generate the Description, What-to-Build, and Video script.</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="absolute -bottom-6 left-8 bg-white border p-3 rounded-lg shadow-md text-sm">Export: <span className="font-semibold">GitHub repo + Demo link + Video script</span></div>
          </div>
        </section>

        <section id="what" className="mt-12 bg-white rounded-2xl p-8 shadow-sm">
          <h2 className="text-2xl font-bold">What is Tabwise?</h2>
          <p className="mt-3 text-slate-600">Simple: when research looks like chaos (10+ tabs, half-broken links, and 3 notes files), Tabwise collects the important parts for you — client-side, private, and fast. Built to satisfy the Devpost rules: everything runs in the browser; the AI work happens locally via Chrome built-in AI when available.</p>

          <div className="mt-6 grid md:grid-cols-3 gap-4">
            <div className="p-4 border rounded-lg">
              <div className="flex items-center gap-3"><FiCheckCircle /><div className="font-semibold">Collect</div></div>
              <p className="mt-2 text-sm text-slate-500">Capture open tabs (URL, title, text snippets) and save them to sessions.</p>
            </div>
            <div className="p-4 border rounded-lg">
              <div className="flex items-center gap-3"><FiCheckCircle /><div className="font-semibold">Summarize</div></div>
              <p className="mt-2 text-sm text-slate-500">Use Summarizer + Prompt APIs to produce TL;DRs, key bullets, and citations.</p>
            </div>
            <div className="p-4 border rounded-lg">
              <div className="flex items-center gap-3"><FiCheckCircle /><div className="font-semibold">Export</div></div>
              <p className="mt-2 text-sm text-slate-500">Generate submission-ready assets: GitHub repo scaffold, README (Devpost description), and a 3-minute video script.</p>
            </div>
          </div>
        </section>
        ...
        <section id="devpost" className="mt-10 bg-white p-8 rounded-2xl shadow-sm">
          ...
          <div className="mt-4 grid md:grid-cols-2 gap-6">
            ...
            <div>
              <div className="bg-slate-50 p-4 rounded">
                <div className="text-sm text-slate-500">Judging highlights</div>
          ...
          <div className="mt-6 flex flex-col md:flex-row gap-3">
            ...
            <a href="#" className="inline-flex items-center gap-2 border px-4 py-2 rounded-md hover:bg-slate-100">Devpost submission page</a>
          </div>
        </section>
        ...
        <section id="team" className="mt-10">
          ...
          <div className="mt-4 grid md:grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-lg shadow-sm">
              ...
              <div className="text-sm text-slate-500">Full-stack dev, product & demo lead</div>
            </div>
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <div className="font-semibold">Co-founder</div>
              <div className="text-sm text-slate-500">Marketing & design</div>
            </div>
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <div className="font-semibold">Contributor</div>
              <div className="text-sm text-slate-500">Extension & testing</div>
            </div>
          </div>

          <div className="mt-6 text-sm text-slate-500">Questions, collab, or want me to write the Devpost text for you? Ping: <a href="mailto:fn234561@gmail.com" className="underline">fn234561@gmail.com</a></div>
        </section>

        <section id="demo" className="mt-10 text-center">
          <h2 className="text-2xl font-bold">Prototype & Links</h2>
          <p className="mt-2 text-slate-600">Early preview: collect tabs, summarize, export README & script. (This is a hackathon-oriented MVP — minimal, focused, and honest.)</p>

          <div className="mt-6 flex justify-center gap-3">
            <a className="inline-flex items-center gap-2 bg-blue-600 text-white px-5 py-3 rounded-md" href="#">Try the web app</a>
            <a className="inline-flex items-center gap-2 border px-5 py-3 rounded-md" href="#">Install extension (beta)</a>
          </div>
        </section>
      ...
      <footer className="bg-white border-t mt-12">
        <div className="container mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-sm text-slate-600">© {new Date().getFullYear()} Tabwise — Built for the Google Chrome Built-in AI Challenge 2025</div>
